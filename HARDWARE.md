...
* If you want this PCB to plug directly into the panel (Output Mode 0):
...
* If you want this PCB to plug into your panel via a IDC ribbon cable (Output Mode 1):
...
* If you want easy jumper wire access to the 9 GPIO and power pins:
  * Female Pin Header 1X5: [AliExpress](https://www.aliexpress.com/item/32821638049.html)
...
* If you want to enable the auto-bootloader (no need to press buttons to upload new firmware):
  * 1206 SMD Ceramic Capacitor 10uF: [AliExpress](https://www.aliexpress.com/item/32879084143.html)
